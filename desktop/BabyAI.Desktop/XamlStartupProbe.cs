...
internal static class XamlStartupProbe
{
    ...
    [
        ...
        ("SECTION Reply safe indicator", $"<Border {Xmlns} Background=\"#12FFFFFF\" BorderBrush=\"#18FFFFFF\" BorderThickness=\"1\" CornerRadius=\"12\" Padding=\"10,7\"><Grid ColumnSpacing=\"8\"><Grid.ColumnDefinitions><ColumnDefinition Width=\"Auto\" /><ColumnDefinition Width=\"*\" /><ColumnDefinition Width=\"Auto\" /></Grid.ColumnDefinitions><Grid Grid.Column=\"0\" Width=\"14\" Height=\"14\" Visibility=\"Collapsed\"><Ellipse Width=\"12\" Height=\"12\" Stroke=\"#BFFFFFFF\" StrokeThickness=\"2\" /><Ellipse Width=\"4\" Height=\"4\" Fill=\"#FFF8FAFF\" /></Grid><TextBlock Grid.Column=\"1\" Text=\"Готов к разговору.\" TextWrapping=\"Wrap\" FontSize=\"11\" Foreground=\"#AFFFFFFF\" /><Button Grid.Column=\"2\" Content=\"Повторить\" FontSize=\"11\" Padding=\"10,4\" CornerRadius=\"10\" Visibility=\"Collapsed\" /></Grid></Border>"),
    ...
    {
        StartupDiagnostics.Log($"XAML remaining probe begin ({Cases.Length} cases)");
        ...
        StartupDiagnostics.Log("XAML remaining probe end");
    }
}
